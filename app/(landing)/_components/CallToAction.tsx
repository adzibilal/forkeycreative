    ...
    return (
        <div className="bg-[url('/images/call-to-action.png')]" id='pricing'>
            <div className='max-con flex flex-col items-center justify-center py-[100px] gap-5 my-5'>
                <h1 className='text-5xl font-extrabold text-white max-sm:text-4xl max-sm:text-center'>Konsultasikan Sekarang</h1>
                <div className='text-2xl font-light text-white w-[60%] text-center mb-4 max-sm:text-lg max-sm:w-full'>
